...
case "$input" in
    ...
    *[A-Za-z]*[0-9]*|*[0-9]*[A-Za-z]*)   echo "The string '$input' is a Mix of Letters and Numbers."    ;;
    *[A-Z]*[a-z]*|*[a-z]*[A-Z]*)       echo "The string '$input' is a Mix of Upper and Lower Case letters."       ;;
    *[A-Z]*)       echo "The string '$input' contains Upper Case letters."      ;;
    *[a-z]*)      echo "The string '$input' contains Lower Case letters."       ;;
    *[0-9]*)      echo "The string '$input' is a Number."       ;;
